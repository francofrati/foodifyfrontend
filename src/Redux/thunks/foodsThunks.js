...
const fetchAllFoods = () => (dispatch) => {
    axios.get("https://foodifyback.herokuapp.com/foods")
        .then((response) => {
...
const fetchAllDiets = () => (dispatch) => {
    axios.get("https://foodifyback.herokuapp.com/foods/diets")
        .then((response) => {
...
const fetchFoodsByTitle = (title) => (dispatch) => {
    axios.get(`https://foodifyback.herokuapp.com/foods?title=${title}`)
        .then((response) => {
...
const fetchFoodsRestaurant = (idRestaurant) => (dispatch) => {
    axios.get(`https://foodifyback.herokuapp.com/foods/foodsRestaurant/${idRestaurant}`)
    .then((response) => {
